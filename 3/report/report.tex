...
For a given image database containing handwritten documents produced by the same author and a set of visual query words we want to detect the documents and their line numbers of all occurrences of the corresponding query words.
