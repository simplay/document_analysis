...
compute image features relying on sift 
perform a k-means clustering on detected image features
map image features to bag of words histogram
compute similarities between the extracted histograms using the 2-norm.
sort all the similarity scores in an ascending order and take the best k neighbors. 
