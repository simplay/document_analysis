...
Source for the project can be found on \url{https://github.com/simplay/document_analysis}.
...
\begin{figure}[ht!]%
\centering
\subfigure[No noise]{\includegraphics[width=0.1\textwidth]{noise_types_clean}\label{fig:types_noise:no_noise}}
\subfigure[S-n-p]{\includegraphics[width=0.1\textwidth]{noise_types_snp}}
\subfigure[Fringes]{\includegraphics[width=0.1\textwidth]{noise_types_fringe}\label{fig:types_noise:fringe_noise}}
...
\begin{figure}[ht!]%
\centering
\subfigure[Original]{\includegraphics[width=0.14\textwidth]{smoothing_comparison_original}}
\subfigure[Gaussian]{\includegraphics[width=0.14\textwidth]{smoothing_comparison_gauss}}
\subfigure[Bilateral]{\includegraphics[width=0.14\textwidth]{smoothing_comparison_bilat}}
...
\begin{figure}[ht!]%
\centering
\subfigure[Original Shape]{\includegraphics[width=0.14\textwidth]{square}}
\subfigure[Response]{\includegraphics[width=0.14\textwidth]{square_response}\label{fig:harris:response}}\\
\subfigure[$G * I_y^2$]{\includegraphics[width=0.14\textwidth]{square_sx2_smoothed}}
\subfigure[$G * I_x^2$]{\includegraphics[width=0.14\textwidth]{square_sy2_smoothed}}
\subfigure[$G * I_x I_y$]{\includegraphics[width=0.14\textwidth]{square_sxy_smoothed}}
...
% TODO: Express taking eigenvalues mathematically?
...
\begin{figure}%
\centering
\subfigure[Original]{\includegraphics[width=0.13\textwidth]{square_noisy} \label{fig:triangle_fringes}}
\subfigure[Preprocessed]{\includegraphics[width=0.13\textwidth]{square_noisy_preprocessed}} 
\subfigure[Response]{\includegraphics[width=0.13\textwidth]{square_noisy_response_with_rect}} \\
\subfigure[Detail of response]{\includegraphics[width=0.18\textwidth]{square_noisy_detail_response}}
...
\centering
\subfigure[No noise]{
\includegraphics[width=0.22\textwidth]{confusion_matrix_Shapes1}
}
\subfigure[Salt-and-pepper noise]{
\includegraphics[width=0.22\textwidth]{confusion_matrix_Shapes2N2B}
}
\subfigure[Fringes]{
\includegraphics[width=0.22\textwidth]{confusion_matrix_Shapes_Noise_Heavy_Validation}
}
\subfigure[Gaussian noise]{
\includegraphics[width=0.22\textwidth]{confusion_matrix_Shapes0_gaussian_noise}
}
