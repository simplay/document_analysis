...
Given a clean image of a shape, either initially given or resulting from a previous pre-processing step, we want to find its corners. Our constraint that each image only contains one shape allows us to directly relate the number of detected corners with the type of shape we are dealing with. \\
