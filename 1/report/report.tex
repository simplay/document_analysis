...
\begin{figure}[ht!]%
\centering
\subfigure[Circle]{\includegraphics[width=0.1\textwidth]{circle} \label{fig:triangle_fringes}}
...
\caption{Shapes that can be detected through our algorithm. The scaling and orientation can be arbitrary.}
...
In this work we only are interested in detecting triangle-, square-, regular 5-star- or circle-shapes. However, each such shape can be arbitrary oriented and scaled. Some example input images are shown in Figure $\ref{fig:tranformed_elementary_shapes}$. 
