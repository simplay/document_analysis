...
Hence, we first want to detect the type of image degeneration and then apply a customized preprocessing that directly addresses present issue. Our algorithm is able to detect whether an image exhibits gaussian noise, Salt-and Peper noise, fringes shape edges or has no (significant) degeneration.
