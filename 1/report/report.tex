...
Finally we need to detect jagged edges on the input (holes and dents along shape edges, see Figure \ref{fig:triangle_fringes} for an example). 
Throughout the report we call this type of distortion \emph{fringes}. 
